...
export const api = {
  ...
  createNote:        (id, note)      => req('POST',   `/clients/${id}/notes`, note),
  updateNote:        (id, nid, note) => req('PUT',    `/clients/${id}/notes/${nid}`, note),
  deleteNote:        (id, nid)       => req('DELETE', `/clients/${id}/notes/${nid}`),
  createAction:      (id, action)    => req('POST',   `/clients/${id}/actions`, action),
  updateAction:      (id, aid, act)  => req('PUT',    `/clients/${id}/actions/${aid}`, act),
  deleteAction:      (id, aid)       => req('DELETE', `/clients/${id}/actions/${aid}`),
